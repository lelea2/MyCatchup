...
define("parse", ["underscore","jquery","backbone"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.Parse;
    };
}(this)));
...
define('router',[
    ...
    'parse',
    'bootstrap'
], function($, _, Backbone, Parse, Bootstrap) {
    var AppRouter = Backbone.Router.extend({
        ...
        defaultRoute: function() {
            ...
            require(['views/IntroView'], function(IntroView) {
                var headerView = new IntroView();
            });
        },
        ...
        scheduleRoute: function() {
            require(['views/HeaderView', 'views/FriendListView'], function(HeaderView, FriendListView) {
                var headerView = new HeaderView(),
        ...
        createGroupRoute: function() {
            require(['views/HeaderView', 'views/GroupCreateView'], function(HeaderView, GroupCreateView) {
                var headerView = new HeaderView(),
...
define('app',[
  ...
  'router' // Request router.js
    ...
    var initialize = function() {
        ...
        Parse.initialize("RqEcKnZnSyne2fZ4nhQvHesmz35rFnDw9upR7YBC", "reBrB5o7NfgnrTE6KddPp85VRrwd8TPBKq9HWiHM");
        window.fbAsyncInit = function() {
    // init the FB JS SDK
    Parse.FacebookUtils.init({
      appId      : '167575003441165',                        // App ID from the app dashboard
      channelUrl : '//catchup.tangorover.com', // Channel file for x-domain comms
      cookie     : true
    });
  };
